...
with pm.Model() as model_det1:
    ...
    # Calculate the geometric factor (gf)
...
with model_det1:
    ...
    plotReconstructedSpectrum(trace, isotope + ' - model_det1 - Unfolded Fluence Spectrum.jpg')
...
with model_det2:
    ...
    plotReconstructedSpectrum(trace, isotope + ' - model_det2 - Unfolded Fluence Spectrum.jpg')
...
with model_det3:
    ...
    plotReconstructedSpectrum(trace, isotope + ' - model_det3 - Unfolded Fluence Spectrum.jpg')
...
with pm.Model() as model_det1_det2:
    ...
    # Calculate the geometric factor (gf) for each detector
    gf_det1_e = np.sum(rspns_mat_det1_e[0], axis=1)
    gf_det1_gam = np.sum(rspns_mat_det1_gam[0], axis=1)
    gf_det2_e = np.sum(rspns_mat_det2_e[0], axis=1)
    gf_det2_gam = np.sum(rspns_mat_det2_gam[0], axis=1)
    ...
    ub_phi_e = np.ones(rspns_mat_det1_e[1][0].size - 1)
    ...
    ub_phi_gam = np.ones(rspns_mat_det1_gam[1][0].size - 1)
...
with model_det1_det2:
    ...
    plotReconstructedSpectrum(trace, isotope + ' - model_det1_det2 - Unfolded Fluence Spectrum.jpg')
...
with model_det1_det3:
    ...
    plotReconstructedSpectrum(trace, isotope + ' - model_det1_det3 - Unfolded Fluence Spectrum.jpg')
...
with model_det2_det3:
    ...
    plotReconstructedSpectrum(trace, isotope + ' - model_det2_det3 - Unfolded Fluence Spectrum.jpg')
...
with model_det1_det2_det3:
    ...
    plotReconstructedSpectrum(trace, isotope + ' - model_det1_det2_det3 - Unfolded Fluence Spectrum.jpg')
